<?php
 ...
 header('Access-Control-Allow-Headers: Access-Control-Allow-Headers, Content-Type, Access-Control-Allow-Methods, Authorization,X-Requested-With');
  ...
  $users->uid   = $data->uid;
  $users->profileid = $data->profileid;
...
// Assign profile id to uid for all the functions work.
$users->uid = $users->profileid;

// echo "profileid:".$users->uid."\n";
...
if($busscnt > 0) {
    ...
    $following->fromusrid = $data->uid;
    $following->uid = $users->profileid;
